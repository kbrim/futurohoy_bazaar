...
export const categoryNavigation = [
  {
    ...
    categoryItem: [
      { icon: "Home", title: "Home", href: "/gift-shop" },
      {
        icon: "Popular",
      ...
      { icon: "Products", title: "Latest Products", href: "/gift-shop/latest" },
    ],
  },
  {
    category: "Top Categories",
    categoryItem: [
      {
        ...
        href: "#",
        child: [
          { title: "Pears, apples, quinces", href: "/gift-shop/apples" },
          { title: "Peaches, plums, apricots", href: "/gift-shop/pulms" },
          { title: "Grapes", href: "/gift-shop/grapes-2" },
        ],
      },
      {
        icon: "Children",
        ...
        href: "#",
        child: [
          { title: "Onion", href: "/gift-shop/onion" },
          { title: "Potato", href: "/gift-shop/potato" },
          { title: "Vegetable Pack", href: "/gift-shop/vegetable-pack" },
        ],
      },
      {
        icon: "Chirstmas",
        ...
        href: "#",
        child: [
          { title: "Pears, apples, quinces", href: "/gift-shop/pears" },
          { title: "Peaches, plums, apricots", href: "/gift-shop/apricots" },
          { title: "Grapes", href: "/gift-shop/grapes" },
        ],
      },
      { icon: "Flower", title: "Flower", href: "/gift-shop/flower" },
      {
        icon: "TeddyBear",
        title: "Teddy Bears",
      ...
      { icon: "Toys", title: "Toys", href: "/gift-shop/toys" },
      { icon: "Football", title: "Ball", href: "/gift-shop/ball" },
      { icon: "BabyToys", title: "Baby Toys", href: "/gift-shop/baby-toys" },
      { icon: "Robot", title: "Robot", href: "/gift-shop/robot" },
    ],
  },
];
