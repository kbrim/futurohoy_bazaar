...
export const categoryNavigation = [
  {
    ...
    categoryItem: [
      { icon: "Home", title: "Home", href: "/grocery-1" },
      {
        icon: "Milk",
        title: "Dairy & Eggs",
        href: "/grocery-1/dairy-and-eggs",
      },
      { icon: "Breakfast", title: "Breakfast", href: "/grocery-1/breakfast" },
      { icon: "Yogurt", title: "Frozen", href: "/grocery-1/frozen" },
      {
        href: "#",
        icon: "Carrot",
        title: "Vegetables",
        child: [
          ...
          { title: "Grapes", href: "/grocery-1/grapes" },
        ],
      },
      {
        href: "#",
        ...
        child: [
          { title: "Onion", href: "/grocery-1/onion" },
          { title: "Potato", href: "/grocery-1/potato" },
          { title: "Vegetable Pack", href: "/grocery-1/vegetable-pack" },
        ],
      },
      {
        href: "#",
  ...
  },
  {
    ...
    categoryItem: [
      ...
      { icon: "Breakfast", title: "Breakfast", href: "/grocery-1/breakfast" },
      { icon: "Yogurt", title: "Frozen", href: "/grocery-1/frozen" },
      { icon: "Honey", title: "Organic", href: "/grocery-1/organic" },
      { icon: "Beer", title: "Canned Food", href: "/grocery-1/canned-food" },
      {
        icon: "Snack",
        title: "Coffee & Snacks",
